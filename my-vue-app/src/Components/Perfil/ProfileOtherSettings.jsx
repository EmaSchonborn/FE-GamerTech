  ...
  return (
    <>
      ...
      <div className={styles.legalSection}>
        <h2 className={styles.titulo} onClick={() => toggleSeccion("anuncios")}>
        ...
        <h2 className={styles.titulo} onClick={() => toggleSeccion("cookies")}>
          Uso de Cookies
        </h2>
        ...
        <h2 className={styles.titulo} onClick={() => toggleSeccion("terminos")}>
