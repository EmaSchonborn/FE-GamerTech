...
const CartPayment = () => {
  ...
  return (
    <div
      ...
      style={{ background: "linear-gradient(to bottom, #8a8a8a, #efefef)" }}
    >
      <h1 className="text-4xl font-extrabold mb-4 animate text-black-600 font-serif">
      ...
      <div className="flex justify-center">
        {(timer = 0 ? navigate("/home") : (handleTimer(),<h3>Se te redirigirá a la página en: {timer} ... </h3>))}
      </div>
    </div>
  );
};
