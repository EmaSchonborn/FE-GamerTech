...
function App() {
  ...
  return (
    ...
    {/* COMPONENTES GLOBABLES QUE PUEDE VER CUALQUIER USUARIO */}

      <Route path='/' element={<h1>Landing</h1>}/>
      <Route path="/home" element={<h1>Home</h1>} />
      <Route path="/product/:id" element={<h1>Detalles del productos</h1>} />
    ...
    {/* COMPONENTES DE AUTENTICACIÓN DEL USUARIO : USAR AUTENTICACIÓN OAUTH2 PARA MÁS SEGURIDAD*/}
